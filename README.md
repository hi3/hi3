...
- `themes/hi3/` - Hugo theme directory
  - `layouts/` - Template files
    ...
    - `video.html` - Video page layout
    - `_default/` - Default layout templates
      - `baseof.html` - Base template wrapper
      - `work.html`, `songs.html` - Page-specific layouts
    ...
    - `shortcodes/` - Custom Hugo shortcodes
      - `hi3title.html` - Title component with blur/glow effect
  - `assets/css/` - CSS source files (Tailwind v4 configuration + custom utilities + Solarized color definitions)
...
The site uses **Tailwind CSS v4** with a Solarized Dark color palette:
- Source CSS: `themes/hi3/assets/css/main.css` (CSS-first configuration with `@theme` block)
